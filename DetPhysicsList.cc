...
void DetPhysicsList::ConstructBosons()
{
  // pseudo-particles
...
void DetPhysicsList::ConstructLeptons()
{
  // leptons
  //  e+/-
...
void DetPhysicsList::ConstructMesons()
{
  //  mesons
...
void DetPhysicsList::ConstructBaryons()
{
  //  barions
...
void DetPhysicsList::ConstructOp()
{
...
void DetPhysicsList::SetVerbose(G4int verbose)
{
...
void DetPhysicsList::SetNbOfPhotonsCerenkov(G4int MaxNumber)
{  
